...
+(NSString *)filterHTML:(NSString *)html
{
    ...
    NSString * str5 = [str4 stringByReplacingOccurrencesOfString:@"br &amp;gt;" withString:@""];
    NSString * str6 = [str5 stringByReplacingOccurrencesOfString:@"&#xD" withString:@""];
    NSString * str7 = [str6 stringByReplacingOccurrencesOfString:@";" withString:@""];
    NSString * str8 = [str7 stringByReplacingOccurrencesOfString:@"\n" withString:@""];
